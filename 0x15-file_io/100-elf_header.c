...
*
* Description: If there is no ELF file - exit code 98.
*/
void check_elf(unsigned char *e_ident)
{
int index;
...
/**
* print_magic - Prints an ELF headers magic numbers.
* @e_ident: A pointer to an array contains the ELF magic numbers.
*
* Description: Separates magic numbers by spaces.
*/
void print_magic(unsigned char *e_ident)
{
int index;
...
* @e_type: ELF type.
* @e_ident: A pointer to an array contains ELF class.
*/
void print_type(unsigned int e_type, unsigned char *e_ident)
{
